...
export default function ReorderSuggestions() {
  ...
  return (
    <>
      <Head>
        <title>ReorderSuggestions - Kent Traders Admin Dashboard</title>
        <meta
          name='description'
          content='ReorderSuggestions functionality for Kent Traders Admin Dashboard'
        />
      </Head>
      ...
      >
        ...
        >
          ...
          <Typography variant='body,1' color='text.secondary'>
            ReorderSuggestions functionality for Kent Traders Admin Dashboard
          </Typography>
        </Box>
