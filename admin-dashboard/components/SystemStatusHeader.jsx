...
export default function SystemStatusHeader() {
  ...
  return (
    <>
      <Head>
        <title>SystemStatusHeader - Kent Traders Admin Dashboard</title>
        <meta
          name='description'
          content='SystemStatusHeader functionality for Kent Traders Admin Dashboard'
        />
      </Head>
      ...
      >
        ...
        >
          ...
          <Typography variant='body,1' color='text.secondary'>
            SystemStatusHeader functionality for Kent Traders Admin Dashboard
          </Typography>
        </Box>
