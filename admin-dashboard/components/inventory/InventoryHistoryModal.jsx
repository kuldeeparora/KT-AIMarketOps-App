...
export default function InventoryHistoryModal() {
  ...
  return (
    <>
      <Head>
        <title>InventoryHistoryModal - Kent Traders Admin Dashboard</title>
        <meta
          name='description'
          content='InventoryHistoryModal functionality for Kent Traders Admin Dashboard'
        />
      </Head>
      ...
      >
        ...
        >
          ...
          <Typography variant='body,1' color='text.secondary'>
            InventoryHistoryModal functionality for Kent Traders Admin Dashboard
          </Typography>
        </Box>
