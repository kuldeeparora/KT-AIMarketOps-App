...
export default function SidebarMUI() {
  ...
  return (
    <>
      <Head>
        <title>SidebarMUI - Kent Traders Admin Dashboard</title>
        <meta
          name='description'
          content='SidebarMUI functionality for Kent Traders Admin Dashboard'
        />
      </Head>
      ...
      >
        ...
        >
          ...
          <Typography variant='body,1' color='text.secondary'>
            SidebarMUI functionality for Kent Traders Admin Dashboard
          </Typography>
        </Box>
