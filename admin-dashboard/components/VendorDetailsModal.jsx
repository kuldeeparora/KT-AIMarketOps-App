...
export default function VendorDetailsModal() {
  ...
  return (
    <>
      <Head>
        <title>VendorDetailsModal - Kent Traders Admin Dashboard</title>
        <meta
          name='description'
          content='VendorDetailsModal functionality for Kent Traders Admin Dashboard'
        />
      </Head>
      ...
      >
        ...
        >
          ...
          <Typography variant='body,1' color='text.secondary'>
            VendorDetailsModal functionality for Kent Traders Admin Dashboard
          </Typography>
        </Box>
