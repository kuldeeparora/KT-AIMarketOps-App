...
export default function AiFeatures() {
  ...
  return (
    <>
      <Head>
        <title>AiFeatures - Kent Traders Admin Dashboard</title>
        <meta
          name='description'
          content='AiFeatures functionality for Kent Traders Admin Dashboard'
        />
      </Head>
      ...
      >
        ...
        >
          ...
          <Typography variant='body,1' color='text.secondary'>
            AiFeatures functionality for Kent Traders Admin Dashboard
          </Typography>
        </Box>
